...
//            rtp.targetPosition = rtp.getSafeTargetFromUser(90);
//        } else if (gamepad1.dpad_right) {
//            rtp.targetPosition = rtp.getSafeTargetFromUser(180);
//        } else if (gamepad1.dpad_up) {
//            rtp.targetPosition = rtp.getSafeTargetFromUser(270);
//        } else if (gamepad1.dpad_down) {
//            rtp.targetPosition = rtp.getSafeTargetFromUser(0);
//        }
//
